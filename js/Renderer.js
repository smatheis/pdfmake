  ...
  renderLine(line, x, y) {
    ...
    for (let i = 0, l = line.inlines.length; i < l; i++) {
      ...
      if (inline.linkToFile) {
        ...
        this.pdfDocument.fileAnnotation(x + inline.x, shiftedY, inline.width, inline.height, attachment, // add empty rectangle as file annotation appearance with the same size as the rendered inline
        {
          AP: {
            N: {
              Type: 'XObject',
